...
enum GenerateCommand {
    static let execute = handleGenerate
}

private func handleGenerate(assumeNonnull: Bool,
                            sdkOverride: [String],
                            destOverride: [String],
                            outputPath: [String],
...
private func cloneProject(at url: URL, to newURL: URL) throws {
    do {
...
private func bridgingHeaderPath(projectURL: URL, targetName: String) throws -> String {
    let output: String
    do {
...
private func generateBridgingSource(headerPath: String, sourceURL: URL) throws {
    do {
...
private func addBridgingSourceToProject(sourceURL: URL, projectURL: URL, targetName: String) throws {
...
private func compilerFlagsForBridgingSource(sourceURL: URL,
                                            projectURL: URL,
                                            targetName: String,
...
private func preprocessBridgingSource(sourceURL: URL, compilerFlags: [String], preprocessedURL: URL) throws {
    do {
...
private func fixNullability(preprocessedURL: URL) throws {
    do {
...
private func generateSwiftInterface(preprocessedURL: URL, compilerFlags: [String]) throws -> String {
...
private func writeGeneratedInterfaceToFile(interface: String, destinationURL: URL?) throws {
    let header =
        """
...
private func cleanUp(projectURL: URL, sourceURL: URL, preprocessedURL: URL) {
